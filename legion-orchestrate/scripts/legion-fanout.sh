...
# executors (GPT-5.4 / GPT-5.5 via legion-delegate; self/Opus slices are returned for Opus
...
#   (optionally {"model":"gpt-5.4", ...}). Archetypes that route to executor=self are NOT
