...
| **Precision implementation** | `migration` | `codex_precision` (Sol) — use where avoiding one rework cycle can offset the higher token rate; measure before moving more volume |
